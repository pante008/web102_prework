...
// Another method instead of ternary operator and counting the total $ of the unfunded games
// using filter to make list of unfunded GAMES JSON objects
// counting total # games and counting total $ unfunded added together
